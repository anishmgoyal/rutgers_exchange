$(document).ready(function() {
	...
	pageLoader.mountHandler(404, function(wnd) {
		messageTool.loadMessage(wnd, "Not Found",
			...
			"whatever happened fixed itself, so try going back. If you end up here again, please send us an email about how " +
			" you got here at " + window.server.supportEmail + ", and we'll try to figure out why you're seeing this.<br /><br />" +
